...
#position the nodes to resemble Strath map
G.nodes["Sports_complex"]['pos'] = (1, 5)
G.nodes["Siwaka"]['pos'] = (5, 5)
G.nodes["Ph_1_a"]['pos'] = (8, 5)
G.nodes["Ph_1_b"]['pos'] = (8, 4)
G.nodes["Mada"]['pos'] = (18, 4)
G.nodes["Phase_2"]['pos'] = (12, 4)
G.nodes["Phase_3"]['pos'] = (15, 3)
G.nodes["STC"]['pos'] = (8, 3)
G.nodes["J1"]['pos'] = (15, 4)
G.nodes["Parking_lot"]['pos'] = (17, 2)
